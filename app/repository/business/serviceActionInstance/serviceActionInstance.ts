...
export class ServiceActionInstanceRepository {
  ...
  public static async get(id: string): Promise<IServiceActionInstance> {
    ...
    ServiceActionInstanceSchema.findById(id).then((result: IMongoServiceActionInstance) => {
      d.resolve(result);
    }).catch((err: any) => {
      d.reject(err);
    });
  ...
  public static async update(id: string, request: any): Promise<IServiceActionInstance> {
    const d = Q.defer<IServiceActionInstance>();

    ServiceActionInstanceSchema.findByIdAndUpdate(id, request, { upsert: true }).then((result: IMongoServiceActionInstance) => {
      d.resolve(result);
    }).catch((err: any) => {
      d.reject(err);
    });
  ...
  public static async patch(id: string, request: any): Promise<IServiceActionInstance> {
    const d = Q.defer<IServiceActionInstance>();
  ...
  public static async delete(id: string): Promise<boolean> {
    ...
    ServiceActionInstanceSchema.findByIdAndRemove(id).then((result: IMongoServiceActionInstance) => {
      d.resolve(true);
    }).catch((err: any) => {
      d.reject(err);
    });
  ...
  public static async getActionsOfService(serviceId): Promise<IServiceActionInstance[]> {
    const d = Q.defer<IServiceActionInstance[]>();
